...
function Modal2022(params) {
  ...
  const generateClues = async (e) => {
    console.log(user);
    let userClue1 = { clue_id: 1, user_id: user, completed: false}
    let userClue2 = { clue_id: 2, user_id: user, completed: false}
    let userClue3 = {clue_id: 3, user_id: user, completed: false}
    let userClue4 = {clue_id: 4, user_id: user, completed: false}
    let userClue5 ={clue_id: 5, user_id: user, completed: false}
    let userClue6 = {clue_id: 6, user_id: user, completed: false}
    let userClue7 = {clue_id: 7, user_id: user, completed: false}
    let userClue8 ={clue_id: 8, user_id: user, completed: false}
    let userClue9 = {clue_id: 9, user_id: user, completed: false}
